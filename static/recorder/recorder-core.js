...
*/
  ...
  var Connect = function() {
    var ctx = Recorder.Ctx; var stream = Recorder.Stream
...
注意：这个不是分贝，因此没用volume当做名称*/
  ...
  Recorder.prototype = initFn.prototype = {
    ...
    open: function(True, False) {
      ...
      var codeFail = function(code, msg) {
        if (/Permission|Allow/i.test(code)) {
          ...
          False('请确认地址栏访问域名是https或浏览器已获得录音权限')
      ...
      var lockOpen = ++Lock.O; var lockClose = Lock.C
    ...
    envCheck: function(envInfo) { // 平台环境下的可用性检查，任何时候都可以调用检查，返回errMsg:""正常，"失败原因"
      ...
      var errMsg; var This = this; var set = This.set
    ...
    envStart: function(mockEnvInfo, sampleRate) { // 平台环境相关的start调用
      var This = this; var set = This.set
    ...
    envIn: function(pcm, sum) { // 和平台环境无关的pcm[Int16]输入
      var This = this; var set = This.set; var engineCtx = This.engineCtx
      ...
      var sizeOld = This.recSize; var addSize = size
    ...
    start: function() {
      ...
      var This = this; var set = This.set; var ctx = Recorder.Ctx
      This._stop()
      This.state = 0
	...
	*/
    stop: function(True, False, autoClose) {
      var This = this; var set = This.set; var t1
